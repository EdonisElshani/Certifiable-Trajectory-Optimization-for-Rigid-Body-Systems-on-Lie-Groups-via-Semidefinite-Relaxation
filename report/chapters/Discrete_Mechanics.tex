...
Let $G$ be a matrix Lie group with Lie algebra $\mathfrak g$, and let $L_d:G\times G\rightarrow\mathbb R$ be smooth \cite{Lee2008}. 
For any $\delta g_k=g_k\eta_k=T_eL_{g_k}(\eta_k) \in T_{g_k}G$ \eqref{eq:discrete_infinitesimal_configuration_variation}, the partial derivative $D_{g_k}L_d(g_k,f_k)\in T_{g_k}^*G$ is characterized by
\begin{equation}
