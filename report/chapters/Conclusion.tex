...
formulated the general optimization problem and identified the research gap: although
...
unforced and controlled 3D-pendulum LGVIs were derived \eqref{eq:discrete_3D_pendulum_EL}. 
...
Thereby, the holonomic constraints were used to eliminate
...
the state of the art literature. Additionally, possible applications of optimization and learning-based methods were identified.
...
$15$ to $31$ min for the special-multibody Acrobot cliques, and $45$ to $113$ min
...
This potentially yields tighter relaxations for difficult multibody problems such as the Acrobot. However, 
first-order solvers generally achieve lower numerical accuracy than interior-point methods. For the 
...
rank condition fails. This procedure improves constructing a feasible full-horizon
trajectory.
